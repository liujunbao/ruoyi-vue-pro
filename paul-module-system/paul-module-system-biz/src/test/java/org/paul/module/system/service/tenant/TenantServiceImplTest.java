package org.paul.module.system.service.tenant;

import org.paul.framework.common.enums.CommonStatusEnum;
import org.paul.framework.common.pojo.PageResult;
import org.paul.framework.tenant.config.TenantProperties;
import org.paul.framework.tenant.core.context.TenantContextHolder;
import org.paul.framework.test.core.ut.BaseDbUnitTest;
import org.paul.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
import org.paul.module.system.controller.admin.tenant.vo.tenant.TenantSaveReqVO;
import org.paul.module.system.dal.dataobject.permission.MenuDO;
import org.paul.module.system.dal.dataobject.permission.RoleDO;
import org.paul.module.system.dal.dataobject.tenant.TenantDO;
import org.paul.module.system.dal.dataobject.tenant.TenantPackageDO;
import org.paul.module.system.dal.mysql.tenant.TenantMapper;
import org.paul.module.system.enums.permission.RoleCodeEnum;
import org.paul.module.system.enums.permission.RoleTypeEnum;
import org.paul.module.system.service.permission.MenuService;
import org.paul.module.system.service.permission.PermissionService;
import org.paul.module.system.service.permission.RoleService;
import org.paul.module.system.service.tenant.handler.TenantInfoHandler;
import org.paul.module.system.service.tenant.handler.TenantMenuHandler;
...
import static org.paul.framework.common.util.collection.SetUtils.asSet;
import static org.paul.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static org.paul.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static org.paul.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static org.paul.framework.test.core.util.AssertUtils.assertPojoEquals;
import static org.paul.framework.test.core.util.AssertUtils.assertServiceException;
import static org.paul.framework.test.core.util.RandomUtils.*;
import static org.paul.module.system.dal.dataobject.tenant.TenantDO.PACKAGE_ID_SYSTEM;
import static org.paul.module.system.enums.ErrorCodeConstants.*;
