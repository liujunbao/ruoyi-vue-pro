package org.paul.module.system.controller.admin.logger.vo.operatelog;

import org.paul.framework.excel.core.annotations.DictFormat;
import org.paul.framework.excel.core.convert.DictConvert;
import org.paul.module.system.enums.DictTypeConstants;
...
public class OperateLogRespVO {
    ...
    @Schema(description = "Java 方法名", requiredMode = Schema.RequiredMode.REQUIRED, example = "org.paul.adminserver.UserController.save(...)")
