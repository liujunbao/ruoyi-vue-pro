package org.paul.framework.operatelog.core.aop;
...
import org.paul.framework.operatelog.core.enums.OperateTypeEnum;
import org.paul.framework.operatelog.core.service.OperateLog;
import org.paul.framework.operatelog.core.service.OperateLogFrameworkService;
import org.paul.framework.web.core.util.WebFrameworkUtils;
...
import static org.paul.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static org.paul.framework.common.exception.enums.GlobalErrorCodeConstants.SUCCESS;
...
public class OperateLogAspect {
    ...
    public Object around(ProceedingJoinPoint joinPoint, Operation operation) throws Throwable {
        ...
        org.paul.framework.operatelog.core.annotations.OperateLog operateLog = getMethodAnnotation(joinPoint,
                org.paul.framework.operatelog.core.annotations.OperateLog.class);
    ...
    public Object around(ProceedingJoinPoint joinPoint,
                         org.paul.framework.operatelog.core.annotations.OperateLog operateLog) throws Throwable {
        return around0(joinPoint, operateLog, null);
    }

    private Object around0(ProceedingJoinPoint joinPoint,
                           org.paul.framework.operatelog.core.annotations.OperateLog operateLog,
