package org.paul.framework.websocket.config;

import org.paul.framework.mq.redis.config.PaulRedisMQConsumerAutoConfiguration;
import org.paul.framework.mq.redis.core.RedisMQTemplate;
import org.paul.framework.websocket.core.handler.JsonWebSocketMessageHandler;
import org.paul.framework.websocket.core.listener.WebSocketMessageListener;
import org.paul.framework.websocket.core.security.LoginUserHandshakeInterceptor;
import org.paul.framework.websocket.core.sender.kafka.KafkaWebSocketMessageConsumer;
import org.paul.framework.websocket.core.sender.kafka.KafkaWebSocketMessageSender;
import org.paul.framework.websocket.core.sender.local.LocalWebSocketMessageSender;
import org.paul.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageConsumer;
import org.paul.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageSender;
import org.paul.framework.websocket.core.sender.redis.RedisWebSocketMessageConsumer;
import org.paul.framework.websocket.core.sender.redis.RedisWebSocketMessageSender;
import org.paul.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageConsumer;
import org.paul.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageSender;
import org.paul.framework.websocket.core.session.WebSocketSessionHandlerDecorator;
import org.paul.framework.websocket.core.session.WebSocketSessionManager;
import org.paul.framework.websocket.core.session.WebSocketSessionManagerImpl;
 ...
 * @author xingyu4j
 */
@AutoConfiguration(before = PaulRedisMQConsumerAutoConfiguration.class) // before YudaoRedisMQConsumerAutoConfiguration 的原因是，需要保证 RedisWebSocketMessageConsumer 先创建，才能创建 RedisMessageListenerContainer
...
public class PaulWebSocketAutoConfiguration {
